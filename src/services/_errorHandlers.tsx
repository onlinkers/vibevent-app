...
export const apiErrorHandler = (err) => {
  ...
  if(!process.env.REACT_APP_DEV_LOGS || process.env.REACT_APP_DEV_LOGS === "false") errorMessage = "An error occured! Please contact our customer service team if problem persists.";
